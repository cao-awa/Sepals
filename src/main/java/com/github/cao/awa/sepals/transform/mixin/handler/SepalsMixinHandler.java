...
public abstract class SepalsMixinHandler {
    ...
    public abstract boolean canApply(Map<String, ModContainer> mods, String mixinGroup, String mixinName, String mixinClassName);

    public abstract void postProcess(Map<String, ModContainer> mods, String mixinGroup, String mixinName, String mixinClassName);
