...
public abstract class SepalsMixinHandler {
    ...
    public abstract boolean canApply(String mixinGroup, String mixinName, String mixinClassName);

    public abstract void postProcess(String mixinGroup, String mixinName, String mixinClassName);
    ...
    public static void registerDefaultHandlers() {
        if (handlers.isEmpty()) {
            ...
            registerHandler("entities", new SepalsWorldMixinHandler());
        }
    }
}
