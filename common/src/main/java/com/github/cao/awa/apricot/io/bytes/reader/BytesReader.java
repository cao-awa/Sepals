...
public class BytesReader {
    ...
    private BytesReader(byte[] bytes, byte[] EMPTY) {
        this.bytes = bytes;
    }
    ...
    public static BytesReader withOutCheck(byte[] bytes) {
        return new BytesReader(bytes, BytesUtil.EMPTY);
    }
    ...
    public BytesReader reader(int length) {
        return BytesReader.withOutCheck(read(length));
    }
}
